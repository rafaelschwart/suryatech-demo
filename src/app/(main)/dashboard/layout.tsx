...
import { PageMotion } from "@/app/(main)/dashboard/_components/motion";
...
/**
 * Rendered statically. Sidebar variant and collapse mode start at their defaults; the preferences
 * store reads the visitor's cookie on the client and the sidebar switches over once it has synced.
 */
